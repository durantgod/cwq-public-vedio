...
public class ProxyServletConfig {
    ...
    public ServletRegistrationBean zlmServletRegistrationBean(){
        ...
        servletRegistrationBean.addInitParameter("targetUri", "http://192.168.10.43:6080");
...
//                String realRequestURI = requestURI.substring(requestURI.indexOf(mediaInfo.getId())+ mediaInfo.getId().length());
                ...
                uri = "http://192.168.10.43:" + serverPort +"/index/hook/null"; // 只是一个能返回404的请求而已， 其他的也可以
            }
            return uri;
        }
        ...
        protected HttpHost getTargetHost(HttpServletRequest servletRequest) {
            ...
            if (mediaInfo != null) {
                ...
                host = new HttpHost("192.168.10.43", serverPort);
            }
            return host;
    ...
    public ServletRegistrationBean recordServletRegistrationBean(){
        ...
        servletRegistrationBean.addInitParameter("targetUri", "http://192.168.10.43:18081");
        servletRegistrationBean.addUrlMappings();
        if (logger.isDebugEnabled()) {
            servletRegistrationBean.addInitParameter("log", "true");
        }
